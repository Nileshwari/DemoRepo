...
//	        }
	...
	public String getCellData(String sheetName, String colName, int rowNum) {
		try {
			...
			// return cell.getStringCellValue();
			else if ((cell.getCellTypeEnum().equals(CellType.NUMERIC)) || (cell.getCellTypeEnum().equals(CellType.FORMULA))) {
			...
			/*
			 * } else if (cell.getCellType()!= null) return ""; else return
	...
	public String getCellData(String sheetName, int colNum, int rowNum) {
		try {
			...
			/*
			 * // if (cell.getCellTypeEnum().equals(CellType.STRING)) return
			 ...
			 * }
			 * 
			 * return cellText; } else if (cell.getCellType().equals(CellType.BLANK) !=
			 * null) return ""; else return String.valueOf(cell.getBooleanCellValue());
			 */
		} catch (Exception e) {
